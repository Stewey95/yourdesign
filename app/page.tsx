...
function EditorPreviewMockup() {
  return (
    <div className="relative mx-auto w-full max-w-5xl">
      ...
      <div className="overflow-hidden rounded-2xl border border-slate-700 bg-slate-950 p-2 shadow-[0_28px_70px_-28px_rgba(15,23,42,0.5)] ring-1 ring-slate-950/5 sm:rounded-3xl sm:p-3">
      ...
      <main className="min-h-screen overflow-x-clip bg-white font-[family-name:var(--font-geist-sans)] text-slate-950">
        ...
        <section id="home" className="relative scroll-mt-20 px-5 pb-20 pt-16 sm:px-6 sm:pb-28 sm:pt-24 lg:px-8 lg:pt-28">
          ...
          <div className="mx-auto max-w-5xl text-center">
            ...
            <h1 className="text-balance text-[2.75rem] font-black leading-[1.03] tracking-[-0.045em] text-slate-950 sm:text-6xl sm:leading-[1.02] lg:text-7xl">
          ...
          <div className="mx-auto grid max-w-7xl gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {benefits.map(({ icon: Icon, title, text }) => (
              <div key={title} className="flex items-start gap-3">
                ...
                <div><h2 className="text-sm font-bold text-slate-900">{title}</h2><p className="mt-1 text-sm leading-5 text-slate-600">{text}</p></div>
              </div>
            ))}
          </div>
        </section>

        <section className="px-5 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-32">
        ...
        <section id="how-it-works" className="scroll-mt-24 bg-slate-950 px-5 py-20 text-white sm:px-6 sm:py-28 lg:px-8 lg:py-32">
        ...
        <section id="features" className="scroll-mt-24 px-5 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-32">
          <div className="mx-auto max-w-7xl">
        ...
        <section id="roadmap" className="scroll-mt-24 border-y border-slate-200/70 bg-slate-50 px-5 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-32">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-14 grid gap-5 md:grid-cols-2">
              <div className="h-full rounded-3xl border border-emerald-200 bg-white p-7 shadow-sm sm:p-8"><div className="flex items-center gap-3"><span className="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600"><Check size={20} /></span><h3 className="text-xl font-bold">Available now</h3></div><div className="mt-6 grid grid-cols-2 gap-3">{completed.map((item) => <span key={item} className="rounded-xl bg-emerald-50 px-3 py-3 text-sm font-semibold text-emerald-800">{item}</span>)}</div></div>
              <div className="h-full rounded-3xl border border-purple-200 bg-white p-7 shadow-sm sm:p-8"><div className="flex items-center gap-3"><span className="flex h-10 w-10 items-center justify-center rounded-xl bg-purple-50 text-purple-600"><Gauge size={20} /></span><h3 className="text-xl font-bold">Coming next</h3></div><div className="mt-6 grid grid-cols-2 gap-3">{comingNext.map((item) => <span key={item} className="rounded-xl bg-purple-50 px-3 py-3 text-sm font-semibold text-purple-800">{item}</span>)}</div></div>
            </div>
          </div>
        </section>
        ...
        <footer className="border-t border-slate-200 bg-white px-5 py-12 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-[1fr_auto] md:items-end">
            <div><Link href="#home" className="inline-flex items-center gap-2 focus-visible:rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"><Image src="/brand/genvilo-icon-master.png" alt="" width={1536} height={1024} className="h-auto w-12 object-contain" /><span className="bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 bg-clip-text text-xl font-extrabold text-transparent">Gripix</span><span className="sr-only">Back to top</span></Link><p className="mt-4 max-w-md text-sm leading-6 text-slate-600">A simple, powerful design workspace for creators, businesses and digital sellers.</p><p className="mt-5 text-xs text-slate-500">Early access · © {new Date().getFullYear()} Gripix</p></div>
            <nav aria-label="Footer navigation" className="flex flex-wrap gap-x-6 gap-y-3 text-sm font-semibold text-slate-600"><a href="#features" className="rounded transition-colors hover:text-slate-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500">Features</a><a href="#how-it-works" className="rounded transition-colors hover:text-slate-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500">How It Works</a><a href="#roadmap" className="rounded transition-colors hover:text-slate-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500">What’s Coming</a><Link href="/create" className="rounded text-blue-600 transition-colors hover:text-blue-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500">Start Creating</Link></nav>
          </div>
        </footer>
      </main>
    </>
