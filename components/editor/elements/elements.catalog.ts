...
export const ELEMENT_CATALOG: readonly ElementAsset[] = [
  ...
  },
  {
    ...
    svg: svg('<rect x="7" y="17" width="86" height="66" rx="14" fill="#7c3aed"/>'),
    defaultSize: { width: 120, height: 84 },
    favourite: false,
    recent: false,
  },
  {
    ...
    svg: svg('<circle cx="50" cy="50" r="43" fill="#0891b2"/>'),
  ...
  },
  {
    ...
    svg: svg('<path d="M50 7 95 91H5Z" fill="#db2777"/>'),
  ...
  },
  {
    ...
    svg: svg('<path d="M7 50H84M62 27l23 23-23 23" fill="none" stroke="#7c3aed" stroke-width="9" stroke-linecap="round" stroke-linejoin="round"/>'),
  ...
  },
  {
    ...
    svg: svg('<path d="m50 5 13.9 28.2L95 37.7 72.5 59.6 77.8 90 50 75.4 22.2 90l5.3-30.4L5 37.7l31.1-4.5Z" fill="#f59e0b"/>'),
